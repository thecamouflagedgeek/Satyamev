    ...
    <main className="bg-black text-white">
      ...
      <section className="relative h-[70vh] flex items-center justify-center text-center px-6 md:px-16">
        ...
        <div className="relative z-10 max-w-3xl mt-16">
          <h1 className="text-4xl md:text-5xl font-semibold">About Satyamev</h1>
      ...
      <section className="bg-white text-black px-6 md:px-16 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-gray-700 leading-relaxed">
            We believe that public discourse should be shaped by long-term civic
            consequence, not short-term virality. Satyamev introduces a
            structured approach to understanding public issues by tracking their
            evolution, impact and continuity.
          </p>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-16 text-left">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Built detailed issue pages, narrative tracking displays and
                continuity visualization components.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm mb-4">Backend & AI Systems</p>
              <p className="text-gray-400 leading-relaxed">
                Developed impact scoring logic, narrative genome engine and data
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Defined platform philosophy, civic evaluation metrics and
